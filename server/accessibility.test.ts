...
describe("accessibility regression contract", () => {
  ...
  it("keeps public project detail routing and narrative content wired", async () => {
    ...
    expect(home).toContain("Project share card");
    expect(home).toContain("Copy project link");
    ...
    expect(routers).toContain("cohorts");
    expect(home).toContain("Visitor cohorts");
    expect(home).toContain("summary?.cohorts");
    expect(routers).toContain('"outbound_click"');
    expect(home).toContain('eventType: "outbound_click"');
    expect(home).toContain("targetUrl");
    expect(routers).toContain('"contact_conversion"');
    expect(routers).toContain('"newsletter_conversion"');
    expect(home).toContain('eventType: "contact_conversion"');
    expect(home).toContain('eventType: "newsletter_conversion"');
    expect(routers).toContain("analyticsTimezone");
    expect(home).toContain('aria-label="Analytics timezone"');
    expect(routers).toContain("digestPreview");
    expect(routers).toContain("digestFrequency");
    expect(home).toContain('aria-label="Digest frequency"');
